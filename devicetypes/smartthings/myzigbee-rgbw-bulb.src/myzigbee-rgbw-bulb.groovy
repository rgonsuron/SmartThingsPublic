...
metadata {
    definition (name: "MyZigBee RGBW Bulb", namespace: "smartthings", author: "SmartThings") {
    ...
    tiles(scale: 2) {
        ...
        controlTile ("colorSat", "device.level", "slider", width: 4, height: 1, inactiveLabel: true, range:"(0..100)") {
            state "saturation", action:"color control.setSaturation", label:'Saturation'
        }
        valueTile ("hueTile", "device.level", inactiveLabel: false, decoration: "flat", width: 2, height: 1) {
            state "hue", label: '${currentValue}'
        }
        controlTile ("colorHue", "device.level", "slider", width: 4, height: 1, inactiveLabel: true, range:"(0..100)") {
            state "hue", action:"color control.setHue", label:'${currentValue}'
        }
        controlTile("colorTempSliderControl", "device.colorTemperature", "slider", width: 4, height: 1, inactiveLabel: false, range:"(2700..6500)") {
            state "colorTemperature", action:"color temperature.setColorTemperature"
        }
        valueTile("colorName", "device.colorName", inactiveLabel: false, decoration: "flat", width: 2, height: 1) {
        ...
        main(["switch"])
        // details(["switch", "colorTempSliderControl", "colorHue", "colorSat", "colorName", "hueTile", "refresh", "rgbSelector"])
        // details (["switch", "rgbSelector", "colorTempSliderControl", "colorName", "refresh"])
